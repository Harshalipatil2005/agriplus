      ...
      child: ListView(
        ...
        children: [
          UserAccountsDrawerHeader(
            accountName: const Text("Harshali"),
            accountEmail: const Text("harshali.22310156@viit.ac.in"),
      ...
      child: Column(
        children: [
          ...
          _buildFeatureCard(
            ...
            'Biogas price calculator',
            const BiogasCalculatorApp(),
          ),
          _buildFeatureCard(
            context,
